...
namespace CanalNoticias.Migrations
{
    ...
    partial class v1
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("CanalNoticias.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("CanalNoticias.Models.Categoria", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("CanalNoticias.Models.Categoria", b =>
                {
                    b.HasOne("CanalNoticias.Models.Noticia")
                        .WithMany("Categorias")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CanalNoticias.Models.ApplicationUser")
                        .WithMany("Claims")
